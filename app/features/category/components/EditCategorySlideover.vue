...
// No puedes asignarte a ti misma como padre.
const parentOptions = computed(() =>
  treeSelectCategory.value.filter(opt => opt.value !== props.category?.id)
)
...
function resetForm() {
  ...
  parentId.value = c?.parent?.id ?? undefined
...
async function onSave() {
  ...
  if (imageBlob.value) formData.append('image', imageBlob.value, 'category.jpg')
      ...
      >
        ...
        <template #info>
          <div class="space-y-6 pt-4">
            ...
            <UFormField label="Categoría padre">
              <USelectMenu
                v-model="parentId"
                :items="parentOptions"
                value-key="value"
